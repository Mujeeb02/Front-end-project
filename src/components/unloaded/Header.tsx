...
const Header = ({wallpaper}) => {
  ...
  return (
    <div className='h-[50vh] w-full flex flex-col justify-end items-start text-white gap-4 pl-16 pb-16' style={{
        ...
        <Link  to={`/details/`} className='ml-4 bg-purple-400 w-[10%] flex items-center justify-center rounded-lg'>Watch trailer</Link>
    </div>
  )
}
